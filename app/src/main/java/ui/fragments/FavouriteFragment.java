 ...
 */
public class FavouriteFragment extends Fragment implements IGPSChangeListener, GoogleApiClient.ConnectionCallbacks,
    ...
    void bindView(View v) {
        parkinglist = (RecyclerView) v.findViewById(R.id.fav_parking_list);
    ...
    public final BroadcastReceiver FavouriteReceiver = new BroadcastReceiver() {
        @Override
        ...
        AndroidPermissions.check(getActivity())
                ...
                .hasPermissions(new Checker.Action0() {
                    ...
                    public void call(String[] permissions) {
                        ...
                        gpsTracker = new GPSTracker(getActivity(), FavouriteFragment.this);
                        grabdataFromAPI(displayLocationbyPlayservice());
    ...
    public void onStart() {
        ...
        LocalBroadcastManager.getInstance(getActivity()).
                registerReceiver(FavouriteReceiver, intentFilter);
    }
